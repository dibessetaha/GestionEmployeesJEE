                    ...
                    <ul class="list list-inline">
                        <li class="d-flex justify-content-between">
                            ...
                            <i class="fa fa-check-circle checkicon"  style="font-size:20px;color:green"></i>
                                <div class="ml-2">
                                    <h6 class="mb-0">&ensp;${c.title}</h6>
									<h6 class="mb-0">&ensp;pour l'employe : </h6>
                                    <h6 class="mb-0">&ensp;${c.nom}</h6>
                                    <h6 class="mb-0">&ensp;${c.prenom}</h6>
                                    <div class="d-flex flex-row mt-1 text-black-50 date-time">
                                        <div>&ensp;<i class="fa-regular fa-calendar"></i> <span class="ml-2">${c.dateContratDebut}</span></div>
                                        <div class="ml-3">&ensp;<i class="fa-regular fa-calendar"></i> <span class="ml-2">${c.dateContratFin}</span></div>
                                    </div>
                                </div>
                            </div>
                        </li>
