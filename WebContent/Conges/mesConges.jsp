    ...
    <div class='container'>
        <div class='card'>
            ...
            <c:forEach var="conge" items="${congees}">
            	<c:set var = "classe" scope = "page" value =""/>
            	<c:set var = "color" scope = "page" value =""/>
            	<c:if test="${conge.etat == true }">
            		<c:set var = "classe" scope = "page" value ="fa fa-check-circle checkicon"/>
            		<c:set var = "color" scope = "page" value ="green"/>
            		
            	</c:if>
            	<c:if test="${conge.etat == false }">
            		<c:set var = "classe" scope = "page" value ="fa-solid fa-circle-xmark"/>
            		<c:set var ="color" scope ="page" value ="red"/>
            	</c:if>
            	<c:if test="${empty conge.etat}">
            		<c:set var = "classe" scope = "page" value ="fa-solid fa-circle-xmark"/>
            		<c:set var = "color" scope = "page" value ="red"/>
            	</c:if>
                <div class="mt-3">   	
                    <ul class="list list-inline">
                        <li class="d-flex justify-content-between">
                            <div class="d-flex flex-row align-items-center"><i class="${classe}"  style="font-size:20px;color:${color}"></i>
                                <div class="ml-2">
